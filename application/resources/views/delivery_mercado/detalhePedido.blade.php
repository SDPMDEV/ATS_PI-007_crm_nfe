...
<section class="section section-md bg-default">
  <div class="container">
    ...
    <div class="row">
      <div class="container">
        <h2 data-wow-delay="0.1s" class="text-success wow slideInLeft">Pedido <strong>{{$pedido->id}}</strong><i style="color: green" class="fa fa-check"></i></h2>
      </div>
    </div>
  ...
  <a href="/delivery/pedir_novamente/{{$pedido->id}}" style="color: #fff" type="button" id="finalizar-venda-cartao" class="button button-{{getenv('COLOR_BUTTON')}}">
    Pedir Novamente
  </a>
