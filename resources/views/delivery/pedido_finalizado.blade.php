				...
				<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td data-th="Subtotal" class="text-center">R${{number_format($i->valorProduto(), 2, ',', '.')}}</td>
						...
						<tfoot>
							<tr class="visible-xs">
								<td class="text-center">Total do pedido: <strong style="color: red">R$ {{number_format($pedido->valor_total + $pedido->desconto, 2, ',', '.')}}</strong>
								</td>
							...
							<tr class="visible-xs">
								<td class="text-center">Total com desconto: <strong style="color: red">R$ {{number_format($pedido->valor_total, 2, ',', '.')}}</strong>
								</td>
