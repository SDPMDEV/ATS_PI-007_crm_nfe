...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form method="get" action="/motoboys/filtro">
					...
					<div class="form-group col-lg-3 col-md-4 col-sm-6">
						...
						<div class="">
							<div class="input-group">
								<select class="form-control custom-select" name="motoboy_id">
			...
			<div class="row">
				<div class="col-lg-3 col-xl-3 col-6">
					<button style="width: 100%" class="btn btn-success disabled" id="btn-pagar" onclick="pagar()">
						...
						Pagar Entregas(s) <strong id="total-select">R$ 0,00</strong></button>
					</div>
				</div>
							...
							<table class="datatable-table" style="max-width: 100%; overflow: scroll">
								<thead class="datatable-head">
									<tr class="datatable-row" style="left: 0px;">
										...
										<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 200px;">Mootoboy</span></th>
										<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Valor</span></th>
										<th data-field="Country" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Pedido</span></th>
									...
									<tr class="datatable-row">
										...
										<td class="datatable-cell">
											<span class="codigo" style="width: 100px;" id="valor">
												<a target="_blank" class="btn btn-info" href="/pedidosDelivery/verPedido/87">{{ $e->pedido->id }}</a>
											</span>
										</td>
										...
										<td class="datatable-cell"><span class="codigo" style="width: 150px;">
											...
											<a class="btn btn-danger" title="REMOVER" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/motoboys/deleteEntrega/{{$e->id}}" }else{return false} })' href="#!">
